...
// ----- CONFIGURAR PUERTO E -----
	DDRE &=~ (1<<PE0);								// Se configura PE0 como entrada (RX0) y PE1 como salida (TX0)
	DDRE |= (1<<DDE1)|(1<<DDE3)|(1<<DDE4)|(1<<DDE5); // Salida PE3, PE4 y PE5 como salidas PWM
// 	PORTE &=~ 1;
// 	PORTE |= 0; 	
...
// ----- CONFIGURAR PUERTO H -----
// 	DDRH &=~ 1;
	DDRH |= (1<<DDH3)|(1<<DDH4)|(1<<DDH5); // Salida PH3, PH4 y PH5 como salidas para el PWM
// 	PORTH &=~ 1;
// 	PORTH |= 0;
